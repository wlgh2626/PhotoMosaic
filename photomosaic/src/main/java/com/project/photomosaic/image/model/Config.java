...
public class Config {
	...
	/*
	 * @Bean(name = "photomosaic") //Make sure to remove /test public Photomosaic
	 * getTestPhotomosaic() throws Exception { File LENA = new
	 * File(Photomosaic.ORIGINAL_DEFAULT_PATH + "/lena.tif"); File SAMPLE = new
	 * File(SampleIO.SAMPLE_DEFAULT_PATH); return new Photomosaic(LENA , SAMPLE); }
	 */
