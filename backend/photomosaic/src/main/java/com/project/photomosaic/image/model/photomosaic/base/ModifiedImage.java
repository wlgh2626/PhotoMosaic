 ...
 *
 */
public abstract class ModifiedImage {
	 ...
	 */
	public ModifiedImage(BufferedImage original) {
	...
	/**
	 * Returns the average RGB value at the specified location of the given image.
	 * Default increment is 1, which is the slowest
	 * 
	 ...
	 * @param increment the next pixel to be calculated will be increment distance
	 *                  away.
